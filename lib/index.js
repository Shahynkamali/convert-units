var convert
  ...
  , measures = {
    ...
    , liquidUnits: require('./definitions/liquidUnits')
    , molarity: require('./definitions/molarity')
    , percentageToSolid: require('./definitions/percentageToSolid')
    , weightPerVolume: require('./definitions/weightPerVolume')
    }
  , Converter;
